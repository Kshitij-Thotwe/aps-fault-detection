...
class ModelTrainerConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        try:
            self.model_trainer_path = os.path.join(training_pipeline_config.artifact_dir, "data")
            self.model_path = os.path.join(self.model_trainer_path, "model", MODEL_FILE_NAME)
